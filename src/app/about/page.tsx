    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        ...
        <p className="mt-3 text-2xl">
          Hello! Im<b> Umer Gul Kaleem </b>, a 21-year-old Computer Science
          ...
          me with its rich culture and dynamic energy. When Im not diving deep
          ...
          communities. Im always eager to learn and grow, and I look forward to
